...
public class UtilsTestsManagementTest {
    public static void loginForTestManagement(String email, String password, String projectName, String homepageUrl) {
        // Enter email
        WebElement usernameInput = TestsManagementTest.driver.findElement(By.cssSelector("input[type='email'][name='email']"));
        WebElement passwordInput = TestsManagementTest.driver.findElement(By.cssSelector("input[type='password'][name='password']"));
        WebElement signInButton = TestsManagementTest.driver.findElement(By.cssSelector("button[data-testid='Button']"));
        ...
        Assert.assertTrue(TestsManagementTest.driver.getCurrentUrl().contains("organizations"), "Sign in failed. User not redirected to dashboard.");
        ...
        try {
            ...
            WebElement newProjectButton = TestsManagementTest.driver.findElement(By.cssSelector("button[data-testid='ProjectList.NewProjectButton']"));
        ...
        WebElement createProjectButton = TestsManagementTest.driver.findElement(By.cssSelector("button[data-testid='Button']"));
    ...
    public static void createTest(){
        ...
        wait = new WebDriverWait(TestsManagementTest.driver, 10);
